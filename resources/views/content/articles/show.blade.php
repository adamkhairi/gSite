            ...
            <div class="flex flex-col md:w-2/2 w-100 px-6 h-full overflow-hidden  ">
                <div class="pb-4 col-span-8 ">
                    <div class="max-w-xl rounded overflow-hidden shadow-lg bg-white">
                        ...
                        <p><span class="vacation-card-price">{{$article->created_at}}</span></p>
                        <div class="px-6 py-4">
                            <div class="relative">
...
{{--{{route('comment.store')}}--}}
                    ...
                    @if(Auth::user()->is_admin)
                        <a href="{{route('posts.edit',['id'=>$article->id])}}"
                           class="px-4 py-1 m-2 rounded btn-gardiant">Modifier</a>
                        <a href="{{route('post.delete',['id'=>$article->id])}}"
                           class="px-4 py-1 m-2 rounded btn-gardiant">Supprimer</a>
